 ...
 *         f1 = f2
 */
    __pyx_v_f2 = (__pyx_v_f0 + __pyx_v_f1);
...
static PyObject *__pyx_pf_3fib_fibonacci(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_3fib_fibonacci(__pyx_v_n, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
